            ...
            <div class="col-md-8">
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body px-lg-5">
                        ...
                        <!-- Form -->
                        <form class="text-center" style="color: #757575;" method="POST" id="payment-form"
                        ...
                        <!-- Name -->
                            ...
                            <div class="md-form">
                                ...
                                ['id' => 'payment_method', 'class' => 'form-control'.($errors->has('payment_method') ? ' is-invalid' : ''), 'placeholder' => 'Select Payment method']) !!}
                                <i class="fas fa-caret-down icon"></i>
